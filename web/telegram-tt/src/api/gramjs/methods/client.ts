...
import {
  APP_CODE_NAME,
  DEBUG, IS_TEST, LANG_PACK, UPLOAD_WORKERS,
} from '../../../config';

const DEBUG_GRAMJS = false;
const TELEGRAM_API_ID = Number(import.meta.env.TG_TELEGRAM_API_ID || '0');
const TELEGRAM_API_HASH = import.meta.env.TG_TELEGRAM_API_HASH || '';
