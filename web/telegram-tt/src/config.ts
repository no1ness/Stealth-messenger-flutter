...
export const APP_CODE_NAME = 'S';
export const APP_ENV = import.meta.env.TG_APP_ENV;
export const APP_NAME = import.meta.env.TG_APP_NAME || 'Stealth';

export const PRODUCTION_HOSTNAME = 'app.stealthpro.ru';
export const PRODUCTION_URL = 'https://app.stealthpro.ru:8445/stealth/';
export const WEB_VERSION_BASE = 'https://app.stealthpro.ru:8445/';
...
export const PAGE_TITLE_TAURI = 'Stealth';
export const INACTIVE_MARKER = '[Inactive]';
export const POCKETBASE_URL = import.meta.env.TG_POCKETBASE_URL;
export const TEST_SESSION = import.meta.env.TG_TEST_SESSION;

export const DEBUG_PAYMENT_SMART_GLOCAL = false;

export const SESSION_LEGACY_USER_KEY = 'stealth_user_auth';
export const SESSION_ACCOUNT_PREFIX = 'stealth_account';

export const MULTIACCOUNT_MAX_SLOTS = 1;
export const GLOBAL_STATE_CACHE_DISABLED = false;
export const GLOBAL_STATE_CACHE_PREFIX = 'st-global-state';
export const SHARED_STATE_CACHE_KEY = 'st-shared-state';
...
export const IS_SCREEN_LOCKED_CACHE_KEY = 'st-is-screen-locked';

export const MEDIA_CACHE_DISABLED = false;
export const MEDIA_CACHE_NAME = 'st-media';
export const MEDIA_CACHE_NAME_AVATARS = 'st-media-avatars';
export const MEDIA_PROGRESSIVE_CACHE_DISABLED = false;
export const MEDIA_PROGRESSIVE_CACHE_NAME = 'st-media-progressive';
export const MEDIA_CACHE_MAX_BYTES = 512 * 1024; // 512 KB
export const CUSTOM_BG_CACHE_NAME = 'st-custom-bg';
export const LANG_CACHE_NAME = 'st-lang-packs-v1';
export const ASSET_CACHE_NAME = 'st-assets';
export const AUTODOWNLOAD_FILESIZE_MB_LIMITS = [1, 5, 10, 50, 100, 500];
export const DATA_BROADCAST_CHANNEL_PREFIX = 'st-global';
export const ESTABLISH_BROADCAST_CHANNEL_PREFIX = 'st-establish';
export const MULTITAB_LOCALSTORAGE_KEY_PREFIX = 'st-multitab';
export const INTERCLIENT_BROADCAST_CHANNEL = 'stealth';
