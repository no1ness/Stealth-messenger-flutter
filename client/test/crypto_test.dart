...
void main() {
  group('E2E Encryption', () {
    ...
    test('Encryption and Decryption Flow', () async {
      ...
      combined.setRange(secretBox.nonce.length + secretBox.cipherText.length,
          combined.length, secretBox.mac.bytes);
      ...
      final ciphertext =
          receivedBytes.sublist(nonceLength, receivedBytes.length - macLength);
