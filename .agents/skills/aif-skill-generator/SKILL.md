...
2. LEVEL 1 — Run automated scan:
   $PYTHON ~/.agents/skills/aif-skill-generator/scripts/security-scan.py <skill-path>
...
2. **LEVEL 1** — Run automated scanner:
   ```bash
   $PYTHON ~/.agents/skills/aif-skill-generator/scripts/security-scan.py <path>
   ```
...
$PYTHON ~/.agents/skills/aif-skill-generator/scripts/security-scan.py <installed-path>
```
...
```bash
$PYTHON ~/.agents/skills/aif-skill-generator/scripts/security-scan.py ./skill-name/
```
