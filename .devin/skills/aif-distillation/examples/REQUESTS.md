...
- `.windsurf/skills/ddd-practices/SKILL.md`
- `.windsurf/skills/ddd-practices/references/SOURCE-MAP.md`
...
- write each child directly under `.windsurf/skills/<prefix>-<child-scope>/`
...
- no writes to the current agent `.windsurf/skills`
...
- save to `.windsurf/skills/platform-operator/`
...
- confirm the resolved target path would stay under the resolved output root (`.windsurf/skills` by default, or `--path` when present)
