...
- `.agent/skills/ddd-practices/SKILL.md`
- `.agent/skills/ddd-practices/references/SOURCE-MAP.md`
...
- write each child directly under `.agent/skills/<prefix>-<child-scope>/`
...
- no writes to the current agent `.agent/skills`
...
- save to `.agent/skills/platform-operator/`
...
- confirm the resolved target path would stay under the resolved output root (`.agent/skills` by default, or `--path` when present)
