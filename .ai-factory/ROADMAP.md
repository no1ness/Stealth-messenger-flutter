...
- [x] **M10 — Design system v2 (Apple Liquid).** Tokens, primitives, signature effects (ScanlineOverlay, GrainOverlay, ChromaticAberration, DecryptText, key-fingerprint backdrop), `GlassPageRoute`, `StealthHaptics`. Source of truth: `docs/design-system.md` + `docs/design-mockups/`. Backing plans: `.ai-factory/plans/feature-ui-design-refactor.md` (6 refinement passes shipped) + `.ai-factory/plans/feature-russian-ui-design-alignment.md`.
